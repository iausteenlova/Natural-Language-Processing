# -*- coding: utf-8 -*-
"""
Created on Fri Jan 17 22:12:51 2020
@author: Axsteen
"""
# nltk is a toolkit used to preprocess the text data for NLP
# json is to read the json file where we have the data for the training
# pickle is
import nltk
...
documents = []
ignore_words = ['?', '!']
# intents.json is our data which we will train our model.
...
model.save('chatbbot_model.h5', hist)
